...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('registration_user', 'user')
        # Adding field 'User.city'
        db.add_column('user', 'city',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=80),
                      keep_default=False)

        # Adding field 'User.state'
        db.add_column('user', 'state',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=80),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('user', 'city')

        # Deleting field 'User.state'
        db.delete_column('user', 'state')
