...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Art.category' to match new field type.
        db.rename_column('art', 'category_id', 'category')
        # Changing field 'Art.category'
        db.alter_column('art', 'category', self.gf('django.db.models.fields.CharField')(default='Painting', max_length=80))
        # Removing index on 'Art', fields ['category']
        db.delete_index('art', ['category_id'])


    def backwards(self, orm):
        # Adding index on 'Art', fields ['category']
        db.create_index('art', ['category_id'])


        # Renaming column for 'Art.category' to match new field type.
        db.rename_column('art', 'category', 'category_id')
        # Changing field 'Art.category'
        db.alter_column('art', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['art.Category'], null=True))
