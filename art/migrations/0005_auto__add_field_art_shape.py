...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Art.shape'
        db.add_column('art', 'shape',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=17, decimal_places=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Art.shape'
        db.delete_column('art', 'shape')
    ...
    models = {
        u'art.art': {
            ...
            'shape': ('django.db.models.fields.DecimalField', [], {'max_digits': '17', 'decimal_places': '16'}),
