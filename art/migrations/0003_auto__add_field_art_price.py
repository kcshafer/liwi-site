...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Art.price'
        db.add_column('art', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Art.price'
        db.delete_column('art', 'price')
