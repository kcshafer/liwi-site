...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Art.height'
        db.add_column('art', 'height',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=12, decimal_places=1),
                      keep_default=False)

        # Adding field 'Art.width'
        db.add_column('art', 'width',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=12, decimal_places=1),
                      keep_default=False)

        # Adding field 'Art.size'
        db.add_column('art', 'size',
                      self.gf('django.db.models.fields.CharField')(default='m', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Art.height'
        db.delete_column('art', 'height')

        # Deleting field 'Art.width'
        db.delete_column('art', 'width')

        # Deleting field 'Art.size'
        db.delete_column('art', 'size')
    ...
    models = {
        u'art.art': {
            ...
            'height': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '1'}),
            ...
            'width': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '1'})
        },
        u'art.arttag': {
