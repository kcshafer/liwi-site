...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Art.category'
        db.add_column('art', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['art.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Art.category'
        db.delete_column('art', 'category_id')


    models = {
        u'art.art': {
            'Meta': {'object_name': 'Art', 'db_table': "'art'"},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['art.Category']", 'null': 'True', 'blank': 'True'}),
