...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Category.sub_category'
        db.delete_column('category', 'sub_category_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Category.sub_category'
        db.add_column('category', 'sub_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='painting', to=orm['art.Category']),
                      keep_default=False)
