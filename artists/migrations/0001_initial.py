...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeaturedArtist'
        db.create_table('featured_artist', (
            ...
            ('last_imprint', self.gf('django.db.models.fields.DateTimeField')()),
            ('total_imprints', self.gf('django.db.models.fields.IntegerField')()),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'artists', ['FeaturedArtist'])


    def backwards(self, orm):
        # Deleting model 'FeaturedArtist'
        db.delete_table('featured_artist')


    models = {
        u'artists.featuredartist': {
            'Meta': {'object_name': 'FeaturedArtist', 'db_table': "'featured_artist'"},
            'active': ('django.db.models.fields.BooleanField', [], {}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_imprint': ('django.db.models.fields.DateTimeField', [], {}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'total_imprints': ('django.db.models.fields.IntegerField', [], {}),
