...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cart', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.User'], null=True, blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'cart', ['Cart'])

        # Adding model 'CartLineItem'
        db.create_table('cart_line_item', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'cart', ['CartLineItem'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CartLineItem'
        db.delete_table('cart_line_item')
    ...
    models = {
        ...
        u'cart.cart': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['registration.User']", 'null': 'True', 'blank': 'True'})
        },
        u'cart.cartlineitem': {
            'Meta': {'object_name': 'CartLineItem', 'db_table': "'cart_line_item'"},
